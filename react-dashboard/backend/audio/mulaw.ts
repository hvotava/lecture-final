...
let mulaw_to_linear: Int16Array;
let linear_to_mulaw: Uint8Array;
 ...
 * @param buffer μ-law data (Buffer nebo Uint8Array)
 * @returns PCM16 jako Int16Array
 */
export function muLawToPCM16(buffer: Buffer | Uint8Array): Int16Array {
  initializeTables();
 ...
 * @param int16 PCM16 data jako Int16Array
 * @returns μ-law jako Buffer
 */
export function pcm16ToMuLaw(int16: Int16Array): Buffer {
  initializeTables();
 ...
 * @param base64 Base64 μ-law string z Twilio
 * @returns PCM16 jako Int16Array
 */
export function base64MuLawToPCM16(base64: string): Int16Array {
 ...
 * @param int16 PCM16 data
 * @returns Base64 μ-law string
 */
export function pcm16ToBase64MuLaw(int16: Int16Array): string {
  const buffer = pcm16ToMuLaw(int16);
  return buffer.toString('base64');
}

// Export pro testování
export { mulaw_to_linear, linear_to_mulaw }; 